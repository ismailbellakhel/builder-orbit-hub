...
export const handleExtractPdf: RequestHandler = async (req, res) => {
  try {
    ...
    const extractedContent: ExtractedContent = {
      title,
      content:
        "PDF content extraction is currently being developed. Your PDF has been received and we're working on implementing full text extraction. Please try the URL extraction feature for web content, or check back soon for PDF support.",
      images: [],
      metadata: {
        wordCount: 0,
        pages: 1,
